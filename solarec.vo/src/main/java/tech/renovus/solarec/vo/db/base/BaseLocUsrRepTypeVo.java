...
@javax.annotation.Generated(value = "Renovus") public class BaseLocUsrRepTypeVo extends BaseDbVo implements IFlags {
	...
	public static final int LENGTH_COLUMN_LOC_USR_REP_TYPE_FLAGS =  20;
	...
	public void setPk(BaseLocUsrRepTypeVo aVo) {
		if(aVo == null) { 
			...
			this.setPk(aVo.cliId, aVo.locId, aVo.usrId, aVo.repTypeId);
		}
	}
