...
public class SmaInverterServiceTest extends BaseInveterTest {
	...
	public void testCallApi() throws IOException {
		...
		when(this.jsonCaller.post(eq(SmaInverterService.SANDBOX_URL_AUTH + SmaInverterService.ENDPOINT_TOKEN), any(), any(), any())).thenReturn(retrieveTokenMock);
		when(this.jsonCaller.bearerGet(eq(SmaInverterService.SANDBOX_URL_DATA + SmaInverterService.ENDPOINT_BC_AUTHROIZE_TOKEN), any(), any(), any())).thenReturn(bcAuthorizeTokenMock);
		...
		when(this.jsonCaller.bearerGet(eq(SmaInverterService.SANDBOX_URL_DATA + SmaInverterService.ENDPOINT_MONITORING_PLAT_DEVICES), any(), any(), any())).thenReturn(devicesMock);
		when(this.jsonCaller.bearerGet(eq(SmaInverterService.SANDBOX_URL_DATA + SmaInverterService.ENDPOINT_MEASUREMENTS_DEVICE), any(), any(), any())).thenReturn(dataMock);
