...
public class Device {
	...
	public Device withExternalId(String externalId) {
		this.externalId = externalId;
		return this;
	}
	...
	public Device withProjectName(String projectName) {
		this.projectName = projectName;
		return this;
	}
	...
	public Device withAddress(String address) {
		this.address = address;
		return this;
	}
	...
	public Device withLatitude(String latitude) {
		this.latitude = latitude;
		return this;
	}
	...
	public Device withLongitude(String longitude) {
		this.longitude = longitude;
		return this;
	}
	...
	public Device withFuelCode(String fuelCode) {
		this.fuelCode = fuelCode;
		return this;
	}
	...
	public Device withDeviceTypeCode(String deviceTypeCode) {
		this.deviceTypeCode = deviceTypeCode;
		return this;
	}
	...
	public Device withCapacity(Integer capacity) {
		this.capacity = capacity;
		return this;
	}
	...
	public Device withCommissioningDate(String commissioningDate) {
		this.commissioningDate = commissioningDate;
		return this;
	}
	...
	public Device withGridInterconnection(Boolean gridInterconnection) {
		this.gridInterconnection = gridInterconnection;
		return this;
	}
	...
	public Device withOffTaker(String offTaker) {
		this.offTaker = offTaker;
		return this;
	}
	...
	public Device withImpactStory(String impactStory) {
		this.impactStory = impactStory;
		return this;
	}
	...
	public Device withImages(List<String> images) {
		this.images = images;
		return this;
	}
	...
	public Device withDeviceDescription(String deviceDescription) {
		this.deviceDescription = deviceDescription;
		return this;
	}
	...
	public Device withEnergyStorage(Boolean energyStorage) {
		this.energyStorage = energyStorage;
		return this;
	}
	...
	public Device withEnergyStorageCapacity(Integer energyStorageCapacity) {
		this.energyStorageCapacity = energyStorageCapacity;
		return this;
	}
	...
	public Device withQualityLabels(String qualityLabels) {
		this.qualityLabels = qualityLabels;
		return this;
	}
	...
	public Device withSDGBenefits(List<String> sDGBenefits) {
		this.sDGBenefits = sDGBenefits;
		return this;
	}
