...
public class Set {
    ...
    @JsonProperty("currentBatteryChargingSetVoltage")
    public void setCurrentBatteryChargingSetVoltage(List<CurrentBatteryChargingSetVoltage> currentBatteryChargingSetVoltage) {
        this.currentBatteryChargingSetVoltage = currentBatteryChargingSetVoltage;
    }

    public Set withCurrentBatteryChargingSetVoltage(List<CurrentBatteryChargingSetVoltage> currentBatteryChargingSetVoltage) {
        this.currentBatteryChargingSetVoltage = currentBatteryChargingSetVoltage;
        return this;
    }
