...
@javax.annotation.Generated(value = "Renovus") public abstract class BaseDataDefinitionDao <T extends DataDefinitionVo > {
	//--- Protected constants -------------------
	...
	public void insert(T vo) {
		...
		if (key != null) vo.setDataDefId(Integer.valueOf(key.intValue()));
	}
