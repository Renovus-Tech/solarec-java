...
public class LocationRowWrapper implements RowMapper<LocationVo> {
	...
	protected Double getResultSetLocCoordLat(ResultSet resultSet, String columnName) throws SQLException { if (resultSet.getString(columnName) != null) { return new Double(resultSet.getDouble(columnName)); } else { return null; } }
	protected Double getResultSetLocCoordLng(ResultSet resultSet, String columnName) throws SQLException { if (resultSet.getString(columnName) != null) { return new Double(resultSet.getDouble(columnName)); } else { return null; } }
	...
	protected Double getResultSetLocOutputCapacity(ResultSet resultSet, String columnName) throws SQLException { if (resultSet.getString(columnName) != null) { return new Double(resultSet.getDouble(columnName)); } else { return null; } }
	protected Double getResultSetLocOutputTotalCapacity(ResultSet resultSet, String columnName) throws SQLException { if (resultSet.getString(columnName) != null) { return new Double(resultSet.getDouble(columnName)); } else { return null; } }
	protected Double getResultSetLocReferenceDensity(ResultSet resultSet, String columnName) throws SQLException { if (resultSet.getString(columnName) != null) { return new Double(resultSet.getDouble(columnName)); } else { return null; } }
	...
	protected String getResultSetLocCountry(ResultSet resultSet, String columnName) throws SQLException { return resultSet.getString(columnName); }
	protected String getResultSetLocCountryAlpha2(ResultSet resultSet, String columnName) throws SQLException { return resultSet.getString(columnName); }
	...
	@Override public LocationVo mapRow(ResultSet resultSet, int arg1) throws SQLException {
		...
		vo.setLocCountry(this.getResultSetLocCountry(resultSet, LocationVo.COLUMN_LOC_COUNTRY));
		vo.setLocCountryAlpha2(this.getResultSetLocCountryAlpha2(resultSet, LocationVo.COLUMN_LOC_COUNTRY_ALPHA_2));
