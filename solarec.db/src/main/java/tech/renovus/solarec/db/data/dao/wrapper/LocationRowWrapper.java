...
@javax.annotation.Generated(value = "Renovus") public class LocationRowWrapper implements RowMapper<LocationVo> {
	...
	protected String getResultSetLocCertProvData(ResultSet resultSet, String columnName) throws SQLException { return resultSet.getString(columnName); }
	...
	@Override public LocationVo mapRow(ResultSet resultSet, int arg1) throws SQLException {
		...
		vo.setLocTypeId(this.getResultSetLocTypeId(resultSet, LocationVo.COLUMN_LOC_TYPE_ID));
		...
		vo.setLocCertProvData(this.getResultSetLocCertProvData(resultSet, LocationVo.COLUMN_LOC_CERT_PROV_DATA));
