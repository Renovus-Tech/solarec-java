...
@javax.annotation.Generated(value = "Renovus") public abstract class BaseLocationDao <T extends LocationVo > {
	//--- Protected constants -------------------
	protected static final String SQL_SELECT_ALL		= "SELECT * FROM location";
	protected static final String SQL_SELECT_BY_ID		= "SELECT * FROM location WHERE cli_id = :cli_id AND loc_id_auto = :loc_id_auto";
	protected String SQL_INSERT					= "INSERT INTO location (cli_id, data_def_id, loc_output_capacity, loc_output_total_capacity, loc_reference_density, loc_data_date_max, loc_data_date_min, loc_demo_date, ctr_id, loc_type_id, loc_coord_lat, loc_coord_lng, loc_name, loc_address, loc_gmt, loc_cert_prov_data, loc_flags, loc_code, loc_state, loc_type) VALUES (:cli_id, :data_def_id, :loc_output_capacity, :loc_output_total_capacity, :loc_reference_density, :loc_data_date_max, :loc_data_date_min, :loc_demo_date, :ctr_id, :loc_type_id, :loc_coord_lat, :loc_coord_lng, :loc_name, :loc_address, :loc_gmt, :loc_cert_prov_data, :loc_flags, :loc_code, :loc_state, :loc_type)";
	protected String SQL_UPDATE					= "UPDATE location SET data_def_id = :data_def_id, loc_output_capacity = :loc_output_capacity, loc_output_total_capacity = :loc_output_total_capacity, loc_reference_density = :loc_reference_density, loc_data_date_max = :loc_data_date_max, loc_data_date_min = :loc_data_date_min, loc_demo_date = :loc_demo_date, ctr_id = :ctr_id, loc_type_id = :loc_type_id, loc_coord_lat = :loc_coord_lat, loc_coord_lng = :loc_coord_lng, loc_name = :loc_name, loc_address = :loc_address, loc_gmt = :loc_gmt, loc_cert_prov_data = :loc_cert_prov_data, loc_flags = :loc_flags, loc_code = :loc_code, loc_state = :loc_state, loc_type = :loc_type WHERE cli_id = :cli_id AND loc_id_auto = :loc_id_auto";
	protected String SQL_DELETE					= "DELETE FROM location WHERE cli_id = :cli_id AND loc_id_auto = :loc_id_auto";
	protected String SQL_ON_CONFLICT_PK_UPDATE	= " ON CONFLICT (cli_id, loc_id_auto) DO UPDATE SET data_def_id = EXCLUDED.data_def_id, loc_output_capacity = EXCLUDED.loc_output_capacity, loc_output_total_capacity = EXCLUDED.loc_output_total_capacity, loc_reference_density = EXCLUDED.loc_reference_density, loc_data_date_max = EXCLUDED.loc_data_date_max, loc_data_date_min = EXCLUDED.loc_data_date_min, loc_demo_date = EXCLUDED.loc_demo_date, ctr_id = EXCLUDED.ctr_id, loc_type_id = EXCLUDED.loc_type_id, loc_coord_lat = EXCLUDED.loc_coord_lat, loc_coord_lng = EXCLUDED.loc_coord_lng, loc_name = EXCLUDED.loc_name, loc_address = EXCLUDED.loc_address, loc_gmt = EXCLUDED.loc_gmt, loc_cert_prov_data = EXCLUDED.loc_cert_prov_data, loc_flags = EXCLUDED.loc_flags, loc_code = EXCLUDED.loc_code, loc_state = EXCLUDED.loc_state, loc_type = EXCLUDED.loc_type";
	...
	protected MapSqlParameterSource createInsertMapSqlParameterSource(T vo) {
		return new MapSqlParameterSource()
			...
			.addValue(LocationVo.COLUMN_LOC_CERT_PROV_DATA, vo.getLocCertProvData())
