...
public abstract class BaseCliLocAlertDao {
	...
	protected String SQL_INSERT					= "INSERT INTO cli_loc_alert (cli_id, loc_id, cli_loc_alert_added, cli_loc_alert_type, cli_loc_alert_data) VALUES (:cli_id, :loc_id, :cli_loc_alert_added, :cli_loc_alert_type, :cli_loc_alert_data)";
	protected String SQL_UPDATE					= "UPDATE cli_loc_alert SET cli_loc_alert_added = :cli_loc_alert_addedAND cli_loc_alert_type = :cli_loc_alert_typeAND cli_loc_alert_data = :cli_loc_alert_data WHERE cli_id = :cli_idAND loc_id = :loc_idAND cli_loc_alert_id_auto = :cli_loc_alert_id_auto";
	...
	protected String SQL_ON_CONFLICT_PK_UPDATE	= " ON CONFLICT (cli_id, loc_id, cli_loc_alert_id_auto) SET cli_loc_alert_added = EXCLUDED.cli_loc_alert_added, cli_loc_alert_type = EXCLUDED.cli_loc_alert_type, cli_loc_alert_data = EXCLUDED.cli_loc_alert_data";
