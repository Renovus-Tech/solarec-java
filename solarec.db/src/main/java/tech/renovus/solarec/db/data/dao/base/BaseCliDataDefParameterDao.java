...
public abstract class BaseCliDataDefParameterDao <T extends CliDataDefParameterVo > {
	...
	public CliDataDefParameterVo findVo(Integer cliId, Integer dataDefId, Integer dataDefParId) { try { return (T) this.jdbc.queryForObject(SQL_SELECT_BY_ID, this.createPkMapSqlParameterSource(cliId, dataDefId, dataDefParId), CliDataDefParameterRowWrapper.getInstance()); } catch (EmptyResultDataAccessException e) { return null; } }
