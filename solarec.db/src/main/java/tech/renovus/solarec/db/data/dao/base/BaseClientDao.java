...
@javax.annotation.Generated(value = "Renovus") public abstract class BaseClientDao <T extends ClientVo > {
	//--- Protected constants -------------------
	...
	protected String SQL_INSERT					= "INSERT INTO client (cli_demo_date, data_def_id, ctr_id, cli_flags, cli_gmt, cli_sec_code, cli_cert_prov_data, cli_name, cli_name_legal, cli_name_address) VALUES (:cli_demo_date, :data_def_id, :ctr_id, :cli_flags, :cli_gmt, :cli_sec_code, :cli_cert_prov_data, :cli_name, :cli_name_legal, :cli_name_address)";
	protected String SQL_UPDATE					= "UPDATE client SET cli_demo_date = :cli_demo_date, data_def_id = :data_def_id, ctr_id = :ctr_id, cli_flags = :cli_flags, cli_gmt = :cli_gmt, cli_sec_code = :cli_sec_code, cli_cert_prov_data = :cli_cert_prov_data, cli_name = :cli_name, cli_name_legal = :cli_name_legal, cli_name_address = :cli_name_address WHERE cli_id_auto = :cli_id_auto";
	protected String SQL_DELETE					= "DELETE FROM client WHERE cli_id_auto = :cli_id_auto";
	protected String SQL_ON_CONFLICT_PK_UPDATE	= " ON CONFLICT (cli_id_auto) DO UPDATE SET cli_demo_date = EXCLUDED.cli_demo_date, data_def_id = EXCLUDED.data_def_id, ctr_id = EXCLUDED.ctr_id, cli_flags = EXCLUDED.cli_flags, cli_gmt = EXCLUDED.cli_gmt, cli_sec_code = EXCLUDED.cli_sec_code, cli_cert_prov_data = EXCLUDED.cli_cert_prov_data, cli_name = EXCLUDED.cli_name, cli_name_legal = EXCLUDED.cli_name_legal, cli_name_address = EXCLUDED.cli_name_address";
	...
	protected MapSqlParameterSource createInsertMapSqlParameterSource(T vo) {
		return new MapSqlParameterSource()
			...
			.addValue(ClientVo.COLUMN_CTR_ID, vo.getCtrId())
